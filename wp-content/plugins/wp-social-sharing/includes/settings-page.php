	...
	<div class="ss-container">
		<div class="ss-column ss-primary">
			...
			<table class="form-table">
					...
					<td>
						<div class="dndicon">
							<?php $s_order=get_option('wss_wp_social_sharing');
								  if(empty($s_order)) $s_order='f,t,l,p,x,r,e';
							...
							foreach ($io as $i){
								switch($i){
                                    ...
                                    case 'r':
										...
										break;
									case 'e':
                                    	echo '<div class="s-icon linkedin-icon" id="e"></div>';
                                    	break;
								}
							}?>
						</div>
				...
				<!-- Email -->
				<tr valign="top">
                	<th><label for="email_text"><?php _e('Email button text','wp-social-sharing');?></label></th>
                    <td>
				...
				<tr valign="top">
					...
					<td>
						<input type="text" name="wp_social_sharing[twitter_username]" id="ss_twitter_username" class="widefat" placeholder="user name" value="<?php echo esc_attr($opts['twitter_username']); ?>">
